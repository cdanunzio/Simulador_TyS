...
module.exports = function (d, M, L) {
  ...
  out.push(ul([
    ...
    'El **cierre**, con la merma o el excedente que surgen de lo pesado en balanza —Depósito ya no los carga a mano (S27)— y las **comparativas** recomendado vs plan vs real y propios vs terceros.',
  ...
  out.push(ul([
    ...
    '**Depósito (DEP)** — sigue los ingresos y cierra el operativo cuando el servicio usa depósito (rol de cierre configurable por servicio, A5). La merma o el excedente **se calculan con lo que declara la balanza al final del operativo**: no hay carga manual (S27); fuera de tolerancia el cierre requiere autorización de Comercial (S12).',
  ...
  out.push(table(['Sección', 'Contenido'], [
    ...
    ['Depósito', 'Ingresos por depósito, destino, cierre y la merma o el excedente calculados desde la balanza.'],
